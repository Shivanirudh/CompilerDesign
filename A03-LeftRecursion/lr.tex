...
%Assignment name
\subsection*{\center{\textbf{Exercise 3: Elimination of Immediate LeftRecursion using C}}}
...
\begin{flushleft}
\lstinputlisting[language = C, firstline = 1, lastline = 92]{lrelim.c}
\end{flushleft}
